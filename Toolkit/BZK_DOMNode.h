...
public:
	...
	enum {
		NAMESPACE, PROPERTY, VALUE, CONTENT, TAG, SPECIAL
	};
	//////////////// fields /////////////////
private:
...
public:
	///class constructor
	BZK_DOMNode() : closed(false), iContent(""), iName("nonametag"), iNameSpace("XMLDoc"), iType(TAG), iNext(NULL),
					iPrev(NULL), iSon(NULL), iFather(NULL), iLastSon(NULL) {
/*
