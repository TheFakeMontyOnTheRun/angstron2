	  ...
	  for (int d=1;d<World.TotalSectors();d++)
	    {
		 ...
		 ////////////////////////////////////////////////////////
			...
			*/
			...
			{	
			  repetir=true;	
			  cout << "YZ "<<c<<" caso 15" << (ptr[0]->GetH1() > ptr[1]->GetH1()) <<endl;			  
