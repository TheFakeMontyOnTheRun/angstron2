...
void HandleInstruction(BZK_Vector<string> &aArg);

void Prompt()
{
  BZK_Vector<string> args;
  string cmd;
  while(1)
		{
		  cout << ">";
...
void Optimize()
{
  ...
  int e,f,g,index;
  int maxsize=1; //esse valor, na função que estiver, responde pela granularidade dos setores.
  ...
  for (int c=1;c<World.TotalSectors();c++)
    {
     ...
     // if (c>30) exit(0);
      ...
      for (int d=0;d<6;d++)
	{
	cout << "checando "<<c<<","<<d<<endl;
	  f=BZK_FastMath::GetOpositeDirection(d);
	 // if (ptr[0]->Get_Connection(d)==0) continue;
	  e=ptr[0]->Get_Connection(d);
	  ptr[1]=World.GetSector(e);
	  ...
	  switch (d)
		...
		if (
		    ptr[1]->GetX0()-ptr[0]->GetX0() > 0.4 ||  //esses valores são responsaveis pelo snapping
		    ptr[1]->GetX0()-ptr[0]->GetX0() < -0.4 ||
		    ptr[1]->GetX1()-ptr[0]->GetX1() > 0.4 || 
		    ptr[1]->GetX1()-ptr[0]->GetX1() < -0.4
		    
		    )

		  {
		    cout << "h-conexao entre "<<c<<" e "<<ptr[0]->Get_Connection(d) << " tem que ter divisao" <<endl;
		    cout<< ptr[0]->GetX0() -  ptr[1]->GetX0()<<" e " <<ptr[0]->GetX1()-ptr[1]->GetX1()<<endl;
		    repetir=true;
		    ...
		    if ( ptr[0]->GetX0() <  ptr[1]->GetX0() &&  ptr[0]->GetX1() ==  ptr[1]->GetX1() && ptr[0]->GetY0()==ptr[1]->GetY1())
			{
			  ...
			  World.AddSector(*ptr[2]);
			    ...
			    ptr[2]->SetX1(ptr[1]->GetX0());
			    ptr[0]->SetX0(ptr[1]->GetX0());			    
			    ptr[2]->SetY0(ptr[0]->GetY0());
			    ptr[2]->SetY1(ptr[0]->GetY1());
			    //cout <<ptr[2]->GetX0()<<","<<ptr[2]->GetY0()<<","<<ptr[2]->GetX1()<<","<< ptr[2]->GetX1()<<endl;
			    cout <<ptr[0]->GetX0()<<","<<ptr[0]->GetY0()<<","<<ptr[0]->GetX1()<<","<< ptr[0]->GetY1()<<endl;
			    cout <<ptr[1]->GetX0()<<","<<ptr[1]->GetY0()<<","<<ptr[1]->GetX1()<<","<< ptr[1]->GetY1()<<endl;
			    cout <<ptr[2]->GetX0()<<","<<ptr[2]->GetY0()<<","<<ptr[2]->GetX1()<<","<< ptr[2]->GetY1()<<endl;
			    continue;
			}


		    //caso 2
		    if ( ptr[0]->GetX1() >  ptr[1]->GetX1() &&  ptr[0]->GetX0() ==  ptr[1]->GetX0() && ptr[0]->GetY0()==ptr[1]->GetY1())
			{
			  cout << "****caso 2"<<endl;
			  ptr[2]=new VAC_Sector();
			  memcpy(ptr[2],ptr[0],sizeof(VAC_Sector));
...
///ok
		    ...
		    if ( ptr[0]->GetX0() >  ptr[1]->GetX0() &&  ptr[0]->GetX1() ==  ptr[1]->GetX1() && ptr[0]->GetY0()==ptr[1]->GetY1())
			{
			  cout << "****caso 3"<<endl;
			  ptr[2]=new VAC_Sector();
			  memcpy(ptr[2],ptr[1],sizeof(VAC_Sector));
			  World.AddSector(*ptr[2]);
			    g=World.TotalSectors()-1;
			    ptr[2]->SetX0(ptr[1]->GetX0());
			    ptr[2]->SetX1(ptr[0]->GetX0());
			    ptr[1]->SetX0(ptr[0]->GetX0());			    
		    ...
		    if ( ptr[0]->GetX0() ==  ptr[1]->GetX0() &&  ptr[0]->GetX1() <  ptr[1]->GetX1() && ptr[0]->GetY0()==ptr[1]->GetY1())
			{
			  ...
			  World.AddSector(*ptr[2]);
			    g=World.TotalSectors()-1;
			    ptr[2]->SetX0(ptr[0]->GetX1());
			    ptr[2]->SetX1(ptr[1]->GetX1());
			    ptr[1]->SetX1(ptr[0]->GetX1());			    
			    ptr[2]->SetY0(ptr[1]->GetY0());
			    ptr[2]->SetY1(ptr[1]->GetY1());
			    //cout <<ptr[2]->GetX0()<<","<<ptr[2]->GetY0()<<","<<ptr[2]->GetX1()<<","<< ptr[2]->GetX1()<<endl;
			    cout <<ptr[0]->GetX0()<<","<<ptr[0]->GetY0()<<","<<ptr[0]->GetX1()<<","<< ptr[0]->GetY1()<<endl;
		...
		if (
		    ptr[1]->GetY0()-ptr[0]->GetY0() > 0.9 || 
		    ptr[1]->GetY0()-ptr[0]->GetY0() < -0.9 ||
		    ptr[1]->GetY1()-ptr[0]->GetY1() > 0.9 || 
		    ptr[1]->GetY1()-ptr[0]->GetY1() < -0.9
		    
		    )
		  {
		    repetir=true;
		    cout << "v-conexao entre "<<c<<" e "<<ptr[0]->Get_Connection(d) << " tem que ter divisao" <<endl;
		    cout<< ptr[1]->GetY0()- ptr[0]->GetY0()<<" e " <<ptr[1]->GetY1()-ptr[0]->GetY1()<<endl;
		    // World.AddSector(*ptr[0]->SpanX(ptr[1]->GetY0()));
		    //cobre os casos 1 e 3
			
		    //caso 1
		    if ( ptr[0]->GetY0() <  ptr[1]->GetY0() &&  ptr[0]->GetY1() ==  ptr[1]->GetY1() && ptr[0]->GetX0()>ptr[1]->GetX0())
			{
			  cout << "****caso 1"<<endl;
			  ptr[2]=new VAC_Sector();
			  memcpy(ptr[2],ptr[0],sizeof(VAC_Sector));
		    ...
		    //caso 2
		    if ( ptr[0]->GetY1() >  ptr[1]->GetY1() &&  ptr[0]->GetY0() ==  ptr[1]->GetY0() && ptr[0]->GetX0()>ptr[1]->GetX0())
			{
			  cout << "****caso 2"<<endl;
			  ptr[2]=new VAC_Sector();
			  memcpy(ptr[2],ptr[0],sizeof(VAC_Sector));
...
///ok
		    ...
		    if ( ptr[0]->GetY0() >  ptr[1]->GetY0() &&  ptr[0]->GetY1() ==  ptr[1]->GetY1() && ptr[0]->GetX0()>ptr[1]->GetX0())
			{
			  ...
			  World.AddSector(*ptr[2]);
			    g=World.TotalSectors()-1;
			    ptr[2]->SetY0(ptr[1]->GetY0());
			    ptr[2]->SetY1(ptr[0]->GetY0());
			    ptr[1]->SetY0(ptr[0]->GetY0());			    
			    ptr[2]->SetX0(ptr[1]->GetX0());
			    ptr[2]->SetX1(ptr[1]->GetX1());
			    //cout <<ptr[2]->GetX0()<<","<<ptr[2]->GetY0()<<","<<ptr[2]->GetX1()<<","<< ptr[2]->GetX1()<<endl;
			    cout <<ptr[0]->GetX0()<<","<<ptr[0]->GetY0()<<","<<ptr[0]->GetX1()<<","<< ptr[0]->GetY1()<<endl;
		    ...
		    if ( ptr[0]->GetY0() ==  ptr[1]->GetY0() &&  ptr[0]->GetY1() <  ptr[1]->GetY1() && ptr[0]->GetX0()>ptr[1]->GetX0())
			{
			  ...
			  World.AddSector(*ptr[2]);
			    g=World.TotalSectors()-1;
			    ptr[2]->SetY0(ptr[0]->GetY1());
			    ptr[2]->SetY1(ptr[1]->GetY1());
			    ptr[1]->SetY1(ptr[0]->GetY1());			    
			    ptr[2]->SetX0(ptr[1]->GetX0());
			    ptr[2]->SetX1(ptr[1]->GetX1());
			    //cout <<ptr[2]->GetX0()<<","<<ptr[2]->GetY0()<<","<<ptr[2]->GetX1()<<","<< ptr[2]->GetX1()<<endl;
			    cout <<ptr[0]->GetX0()<<","<<ptr[0]->GetY0()<<","<<ptr[0]->GetX1()<<","<< ptr[0]->GetY1()<<endl;
	  ...
	  for (int d=1;d<World.TotalSectors();d++)
	    {
		 ...
		 ////////////////////////////////////////////////////////
			...
			*/
			...
			{	
			  repetir=true;	
			  cout << "YZ caso 15" << (ptr[0]->GetH1() > ptr[1]->GetH1()) <<endl;			  
