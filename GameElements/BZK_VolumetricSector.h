 ...
 int BehindZ(BZK_VolumetricSector &aSector)
   {
     ...
     //cout <<"quem � maior em Z?"<<(rect1->y) <<" ou "<<rect2->y<<endl;
     //cout <<"quem � maior?"<<(rect1->y+rect1->h) <<" ou "<<rect2->y+rect2->h<<endl;

    if ((rect1->y)<rect2->y) 
      {
      if ((rect1->y+rect1->h)<rect2->y)  return 1;

      return 0; //definir caso de subdivis�o.
      }
   ...
   if ((rect1->y)==rect2->y) 
	...
	if ((rect2->y+rect2->h)<(rect1->y+rect1->h))  return 2;  
      ...
      return 0; //definir caso de subdivis�o.
       ...
       //  return BehindX(aSector); //por enquanto ainda n�o sabe direito oque fazer...
       return 0;
   }
 //-----------------------------------------------------
 int BehindX(BZK_VolumetricSector &aSector)
   {
     ...
     //se this estiver na frente (for menor), retorna 1
     //cout <<"quem � maior em X?"<<(rect1->x) <<" ou "<<rect2->x<<endl;
     if ((rect1->x+rect1->w)<rect2->x) return 1; //ok

     if ((rect2->x+rect2->w)<rect1->x) return 2; 
     //cout <<"quem � maior?"<<(rect1->x+rect1->w) <<" ou "<<rect2->x+rect2->w<<endl;
	...
	if ((rect2->x+rect2->w)<(rect1->x+rect1->w)) return 2; 
     ...
     return 0; //por enquanto ainda n�o sabe direito oque fazer...
   }
*/
	//-----------------------------------------------------
	/*
