//implementa uma maquina de estados em cima das entidades básicas.
enum {SPECTACTOR,WAITING,DONE};
//==============================================================================================
...
///@brief handle events (BZK events)
  bool PushEvent(int aEvent)
     {///forwards events to the entity layer
